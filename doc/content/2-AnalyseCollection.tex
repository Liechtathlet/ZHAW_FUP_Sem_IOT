...
\begin{itemize}
\itemBfText{.NET Core in 32-Bit}{Aktuell gibt es vom .NET Core keine 32-Bit Implementation. Sämtliche Raspberry Pi Modelle basieren auf einer ARM 32-Bit Architektur. Ausgenommen davon ist das neuste Model, der Raspberry Pi 3 Model B. Ebenfalls gibt es Raspbian aktuell nur in einer 32-Bit Version.}
...
\todo{Absatz bezüglich Wertebereich der Sensoren}
